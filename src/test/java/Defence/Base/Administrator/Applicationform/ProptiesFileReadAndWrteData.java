...
public class ProptiesFileReadAndWrteData {
    public static void main(String[] args) {
        // Define the path to your properties file
        String filePath = "C:\\Users\\PC2\\eclipse-workspace\\SignalProject\\UploadFiles\\SubmissionDataRandWte.properties";
        ...
        try (FileOutputStream fileOutput = new FileOutputStream(filePath)) {
            ...
            properties.setProperty("newKey", "......ONLY-SIGNAL.......");
     ...
     // Reading data from the properties file
        try (FileInputStream fileInput = new FileInputStream(filePath)) {
            ...
            String value = properties.getProperty("newKey");
...
//		driver = ProptiesFileReadAndWrteData.setChromeDriver();
...
//		ProptiesFileReadAndWrteData.setBrowser(url);
//		waitForSeconds(5);
//		
